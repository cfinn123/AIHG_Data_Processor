...
df = pd.read_excel('COVID_test.xls', sheetname='Results', skiprows=42, header=0)
# df = pd.read_excel('nCoV_pilot_03_17_2020.xls', sheetname='Results', skiprows=42, header=0)
...
LOG_FILENAME = 'test_covid_output_' + timestr + '.log'
# LOG_FILENAME = 'pilot_covid_output_' + timestr + '.log'
...
logging.info('\n' + controls.to_string())
logging.warning('\t')
logging.warning(str('If any of the above controls do not exhibit the expected performance as described, the assay may '
